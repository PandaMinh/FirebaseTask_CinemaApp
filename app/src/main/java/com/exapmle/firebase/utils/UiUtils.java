package com.exapmle.firebase.utils;
...
public final class UiUtils {
    ...
    public static void showSnack(View anchor, String message) {
        ...
        snackbar.setBackgroundTint(ContextCompat.getColor(anchor.getContext(), R.color.color_surface_alt));
        snackbar.setTextColor(ContextCompat.getColor(anchor.getContext(), R.color.color_text_primary));
        snackbar.show();
    }
